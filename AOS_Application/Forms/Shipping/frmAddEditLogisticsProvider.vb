...
Public Class frmAddEditLogisticsProvider
    ...
    Friend vObjectName As String = "Logistics Provider"

    'here is where you dimension your object variables for the form
    Dim oItem As Logistics
    ...
    Private Sub updateTimeLabels()
        If IsDBNull(oItem.Createdby) Or oItem.Createdby = Nothing Then
            lblCreated.Text = ""
        Else
            lblCreated.Text = "Created on " & IIf(IsDBNull(oItem.Createtime), "", FormatDateTime(oItem.Createtime, DateFormat.GeneralDate)) & IIf(IsDBNull(oItem.Createdby), "", " by " & oItem.Createdby)
        End If
