...
Public Class rptProductLabelForInventoryItem

    Public Sub New(ByVal vInvItemNum As Integer)
        InitializeComponent()
        fillDataSet(vInvItemNum)
    End Sub

    Private Sub fillDataSet(ByVal vInvItemNum As Integer)
        Dim oRpt As New ViewRptProductLabelForInventoryItem
        oRpt.Query.Where(oRpt.Query.Invitemnumber.Equal(vInvItemNum))
        oRpt.Query.Load()
