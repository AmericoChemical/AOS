...
Public Class rptBillOfLading_OLD
    ...
    Private Sub lblBO2_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles lblBO2.BeforePrint
        If eQty.Text = "0" Then
            lblBO2.Visible = True
        Else
