...
Public Class rptBillOfLading3
    ...
    Private Sub fillDataSet(ByVal vID As Integer)
        ...
        Dim oRpt As New ViewRptBillOfLading3Collection
        oRpt.Query.Where(oRpt.Query.LoadID.Equal(vID))
        ...
        For Each oRec As ViewRptBillOfLading3 In oRpt
    ...
    Private Sub xrItemLine2_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles xrItemLine2.BeforePrint
        xrItemLine2.Text = xrDOTDesc.Text + " " + xrHazMatDesc.Text
        Try
            If txtHazMatID.Text = "1" Or txtHazMatID.Text = "" Then
                xrItemLine2.ForeColor = Color.Black
            Else
                xrItemLine2.ForeColor = Color.Red
            End If
        Catch ex As Exception
        End Try
    End Sub

    Private Sub xrItemLine1_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles xrItemLine1.BeforePrint
        xrItemLine1.Text = xrItemDescription.Text + "  (" + xrProdVolUnits.Text + " " + xrProdVolUOM.Text + " / " + xrProdWgtUnits.Text + " " + xrProdWgtUOM.Text + ")  " + "[" + xrCustProdCode.Text + "]"
        Try
            If txtHazMatID.Text = "1" Or txtHazMatID.Text = "" Then
                xrItemLine1.ForeColor = Color.Black
            Else
                xrItemLine1.ForeColor = Color.Red
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub xrQuoteNumber_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles xrQuoteNumber.BeforePrint
        Try
            If xrCarrierQuoteNumber.Text <> "" Then
                xrQuoteNumber.Text = "Quote#: " + xrCarrierQuoteNumber.Text
            Else
                xrQuoteNumber.Text = ""
            End If
        Catch ex As Exception
    ...
    Private Sub txtSuppliedYes_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles txtSuppliedYes.BeforePrint
        If vHazMatOnBoard Then
