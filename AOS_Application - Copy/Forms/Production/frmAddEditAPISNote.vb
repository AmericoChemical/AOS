...
Public Class frmAddEditAPISNote
    ...
    Friend vObjectName As String = "APIS Note"

    'here is where you dimension your object variables for the form
    Dim oItem As Apisnote
    ...
    Private Function getNoteCount(ByVal vAPISNum As Integer) As Integer
    ...
    Private Sub addNewObject()
        ...
        oItem.Sequence = getNoteCount(vAPISNum) + 1
        oItem.Save()
